                ...
                <div className="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                    <div className="page-title d-flex flex-column me-5">
                        ...
                        <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                            ...
                            <li className="breadcrumb-item text-dark"></li>
                        </ul>
                    </div>
                    <div className="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                        <div className="d-flex align-items-center">
                            <span className="fs-7 fw-bolder text-gray-700 pe-4 text-nowrap d-none d-xxl-block">Sort By:</span>
                            <select className="form-select form-select-sm form-select-solid w-100px w-xxl-125px" data-control="select2" data-placeholder="Latest" data-hide-search="true">
                                <option value=""></option>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <span className="fs-7 text-gray-700 fw-bolder d-none d-sm-block">Impact
                                <span className="d-none d-xxl-inline">Level</span>:</span>
                            <div className="d-flex align-items-center ps-4" id="kt_toolbar">
                                <div id="kt_toolbar_slider" className="noUi-target noUi-target-primary w-75px w-xxl-150px noUi-sm"></div>
                                <span id="kt_toolbar_slider_value" className="d-flex flex-center bg-light-primary rounded-circle w-35px h-35px ms-4 fs-7 fw-bolder text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Set impact level"></span>
                            </div>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <span className="fs-7 text-gray-700 fw-bolder pe-3 d-none d-xxl-block">Quick Tools:</span>


                            <div className="d-flex">
                                <a className="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                                    <span className="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <div className="d-flex align-items-center">
                                    <a className="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                                        <span className="svg-icon svg-icon-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div className="tab-content">
                                            <div className="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                                ...
                                                <div className="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Project Alice</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">HR Confidential</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Company HR</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Project Redux</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Project Breafing</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Banner Assets</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="mb-0 me-2">
                                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bolder">Icon Assets</a>
                                                ...
                                                <div className="py-3 text-center border-top">
                                                    <a href="../../demo8/dist/pages/profile/activity.html" className="btn btn-color-gray-600 btn-active-color-primary">View All
                                                ...
                                                <div className="d-flex flex-column px-9">
                                                    ...
                                                    <div className="pt-10 pb-0">
                                                        ...
                                                        <div className="text-center mt-5 mb-9">
                                                            <a className="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
                                                        </div>
                                                ...
                                                <div className="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">New order</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">New customer</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Payment process</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Search query</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">API connection</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Database restore</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">System update</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Server OS update</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">API rollback</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Refund process</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Withdrawal process</a>
                                                    ...
                                                    <div className="d-flex flex-stack py-4">
                                                        ...
                                                        <div className="d-flex align-items-center me-2">
                                                            ...
                                                            <a className="text-gray-800 text-hover-primary fw-bold">Mail tasks</a>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                                        ...
                                        <div className="row g-0">
                                            ...
                                            <div className="col-6">
                                                <a href="../../demo8/dist/pages/projects/budget.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                                    fi
                                            ...
                                            <div className="col-6">
                                                <a href="../../demo8/dist/pages/projects/settings.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                                            ...
                                            <div className="col-6">
                                                <a href="../../demo8/dist/pages/projects/list.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                                    bs
                                                    <span className="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div className="col-6">
                                                <a href="../../demo8/dist/pages/projects/users.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
