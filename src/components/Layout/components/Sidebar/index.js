        ...
        <div id="kt_aside" className="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div className="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
                    ...
                    <div className="aside-user-info flex-row-fluid flex-wrap ms-5">
                        <div className="d-flex">
                            <div className="flex-grow-1 me-2">
                                <div className="text-white text-hover-primary fs-6 fw-bold">
                                    Cuong
                                </div>
                ...
                <div className="aside-search py-5">
                    ...
                    <div id="kt_header_search" className="d-flex align-items-center" data-kt-search-keypress="true"
                        ...
                        <form data-kt-search-element="form" className="w-100 position-relative" autoComplete="off">
                            ...
                            <input type="text" className="form-control ps-13 fs-7 h-40px" name="search" value=""
                        ...
                        <div data-kt-search-element="content"
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <div data-kt-search-element="results" className="d-none">
                                    ...
                                    <div className="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <h3 className="fs-5 text-muted m-0 pb-5" data-kt-search-element="category-title">Users
                                        </h3>
                                        ...
                                        <a className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    <img className="w-20px h-20px" src="assets/media/svg/brand-logos/tvit.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                        ...
                                        <a className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    <img className="w-20px h-20px" src="assets/media/svg/misc/infography.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                        ...
                                        <a className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    <img className="w-20px h-20px" src="assets/media/svg/brand-logos/leaf.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                        ...
                                        <a className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    <img className="w-20px h-20px" src="assets/media/svg/brand-logos/tower.svg"
                                                        alt="" />
                                                </span>
                                            </div>
                                        ...
                                        <a className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    :Svg Icon | path: icons/duotune/gen
                                ...
                                <div data-kt-search-element="main">
                                    ...
                                    <div className="scroll-y mh-200px mh-lg-325px">
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="symbol symbol-40px me-4">
                                                <span className="symbol-label bg-light">
                                                    :Svg Icon | path: icons/duotune/electro
                                                    <span className="svg-icon svg-icon-2 svg-icon-primary">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
                                            ...
                                            <div className="d-flex flex-column">
                                                <a
                                                    className="fs-6 text-gray-800 text-hover-primary fw-bold">BoomApp by
                                                    Keenthemes</a>
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bold">"Kept
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bold">"KPI
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a
                                                    className="fs-6 text-gray-800 text-hover-primary fw-bold">Project Reference
                                                    FAQ</a>
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a
                                                    className="fs-6 text-gray-800 text-hover-primary fw-bold">"FitPro App
                                                    Development</a>
                                                <span className="fs-7 text-muted fw-bold">#84250</span>
                                            </div>
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a className="fs-6 text-gray-800 text-hover-primary fw-bold">Shopix
                                                    Mobile App</a>
                                        ...
                                        <div className="d-flex align-items-center mb-5">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a
                                                    className="fs-6 text-gray-800 text-hover-primary fw-bold">"Landing UI Design"
                                                    Launch</a>
                            ...
                            <form data-kt-search-element="preferences" className="pt-1 d-none">
                                ...
                                <div className="py-4 border-bottom">
                                    <label
                                        className="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                        <span className="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Affiliate
                                            Programs</span>
            ...
            <div className="aside-menu flex-column-fluid">
                ...
                <div className="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
